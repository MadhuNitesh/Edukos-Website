<?php
	...
	if(isset($_POST['register'])){
		...
		if(strlen($pass) < 8 || !$number || !$uppercase || !$lowercase || !$specialChars) {
		    $msg=$msg."Password must contain letters, numbers, special characters(@,#,$,*,.).<br>";
	    }
		if($pass!=$cpass)
        {
        ...
        {
			$query="UPDATE `fac_details` SET `pass` = '$pass' WHERE `fid`=$fac_no";
...
<html>
    ...
    <body>
        <div class="center">
            ...
            <form id="form" method="POST" action="21.1.fac_otp_change_pass.php">
                <div class="txt_field">
