<?php
    ...
    if(isset($_POST['btn1']))
    {
        ...
        $destination = 'Uploads/sem5/oe1/' . $filename;
        ...
        else
        {
            ...
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','oe1')";
    ...
    if(isset($_POST['btn2']))
    {
        ...
        $destination = 'Uploads/sem5/cp/' . $filename;
        ...
        else
        {
            if(move_uploaded_file($file,$destination))
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','cp')";
    ...
    if(isset($_POST['btn3']))
    {
        ...
        $destination = 'Uploads/sem5/cd/' . $filename;
        ...
        else
        {
            if(move_uploaded_file($file,$destination))
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','cd')";
    ...
    if(isset($_POST['btn4']))
    {
        ...
        $destination = 'Uploads/sem5/dbms/' . $filename;
        ...
        else
        {
            if(move_uploaded_file($file,$destination))
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','dbms')";
    ...
    if(isset($_POST['btn5']))
    {
        ...
        $destination = 'Uploads/sem5/daa/' . $filename;
        ...
        else
        {
            if(move_uploaded_file($file,$destination))
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','daa')";
    ...
    if(isset($_POST['btn6']))
    {
        ...
        $destination = 'Uploads/sem5/qa1/' . $filename;
        ...
        else
        {
            if(move_uploaded_file($file,$destination))
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','qa1')";
    ...
    if(isset($_POST['btn7']))
    {
        ...
        $destination = 'Uploads/sem5/pe1/' . $filename;
        ...
        else
        {
            if(move_uploaded_file($file,$destination))
            {
                $sql = "INSERT INTO sem5(Name,Size,Subject) values('$filename','$size','pe1')";
...
<html>
    ...
    <div id="sub10" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <br><br>
            <a href="admin_sem5_oe1.php" target="_blank">View Files</a>
        </form>
    </div> 
    ...
    <div id="sub1" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <br><br>
            <a href="admin_sem5_cp.php" target="_blank">View Files</a>
        </form>
    </div> 
    ...
    <div id="sub2" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="admin_sem5_cd.php" target="_blank">View Files</a>
        </form>
    </div>
    ...
    <div id="sub3" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="admin_sem5_dbms.php" target="_blank">View Files</a>
        </form>
    </div>
    ...
    <div id="sub4" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="admin_sem5_daa.php" target="_blank">View Files</a>
        </form>
    </div>
    ...
    <div id="sub5" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="admin_sem5_qa1.php" target="_blank">View Files</a>
        </form>
    </div>
    ...
    <div id="sub6" class="sub">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="admin_sem5_pe1.php" target="_blank">View Files</a>
        </form>
    </div>
