<?php
    ...
    if(isset($_POST['register']))
    {
                ...
                {
                    header('Location:admin_sem1.php');
                }

                if( $year == "FIRST_YEAR" && $sem == "SECOND_SEM")
                {
                    header('Location:admin_sem2.php');
                }

                if( $year == "SECOND_YEAR" && $sem == "THIRD_SEM")
                {
                    header('Location:admin_sem3.php');
                }

                if( $year == "SECOND_YEAR" && $sem == "FOURTH_SEM")
                {
                    header('Location:admin_sem4.php');
                }

                if( $year == "THIRD_YEAR" && $sem == "FIFTH_SEM")
                {
                    header('Location:admin_sem5.php');
                }

                if( $year == "THIRD_YEAR" && $sem == "SIXTH_SEM")
                {
                    header('Location:admin_sem6.php'); 
                }
    }
?>
<html>
